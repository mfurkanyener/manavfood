const en = {
    ...
    sustainability: {
        ...
        heroDesc: "At ManavFood, we believe sustainability is more than a commitment — it’s our shared responsibility. From sourcing to packaging, every step is guided by respect for nature, support for local farmers, and the pursuit of long-term ecological balance.",
        certifiedBy: "Certified by |",
        ifsTitle: "IFS Food Standard",
        ifsDesc: "Reviews food production processes to ensure quality, safety, authenticity, and compliance with customer and legal requirements. Based on ISO 9001.",
        globalgapTitle: "Global Good Agricultural Practice (Global G.A.P)",
        globalgapDesc: "A certification ensuring sustainable, safe, and traceable agriculture and aquaculture practices. Emphasizes environmental care and worker welfare.",
        brcTitle: "BRC",
        brcDesc: "BRC Global Standard ensures food safety, quality, and operational criteria across the supply chain. Recognized worldwide for compliance assurance.",
        sedexTitle: "Sedex",
        sedexDesc: "A global platform that promotes responsible business practices, focusing on labor rights, health & safety, and ethical trade transparency.",
        isoTitle: "ISO 22000",
